...
spirv.module Logical GLSL450 requires #spirv.vce<v1.0, [Shader], []> {
    ...
    // CHECK: linkage_attributes = ["outside.func", "Import"]
    spirv.func @outside.func.with.linkage(%arg0 : i8) -> () "Pure" attributes {linkage_attributes=["outside.func", "Import"], VectorComputeFunctionINTEL}
